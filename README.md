...
3. [TPC-DS](https://github.com/semanticdatalayer/sml-models-tutorials-tpc-ds) - a complex, multi-fact model that encodes the [TPC-DS](https://www.tpc.org/tpcds/) benchmark model in SML.
